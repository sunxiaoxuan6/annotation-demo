...
//        1、模拟数据
    ...
    public void testDelete(){
        int num = messageMapper.delete(8);
        log.info("删除的数据:{}",num);
    }
    ...
    public void testUpdate(){
        Message message=Message.builder().msgId(1).msgText("name").msgSummary("孙").build();
    ...
    public void testUpdateText(){
        Message message=Message.builder().msgId(2).msgText("username").msgSummary("").build();
